...
public:
    ...
    void render(U8G2& u8g2) override {
        ...
        u8g2.setCursor(0, 12); u8g2.print("READY TO START LAP");
        u8g2.setCursor(0, 30); u8g2.print("PB: "); u8g2.print(buf);
        u8g2.setCursor(0, 48); u8g2.print("SAT: "); u8g2.print((int)satellites);
    }
};
